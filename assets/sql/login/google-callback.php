    ...
    if ($user) {
        ...
        if ($user['role'] == 'Director'|| $user['role'] == 'VPSLD') {
            ...
            if ($user['role'] == 'Director') {
                header("Location: /cca/assets/pages/director/dashboard-page.php");
            } elseif ($user['role'] == 'VPSLD') {
                header("Location: /cca/assets/pages/vpsld/dashboard-page.php");
            }
            ...
            header("Location: /cca/assets/pages/organization/dashboard-page.php");
        } else {
            echo "Invalid role!";
        }
    } else {
