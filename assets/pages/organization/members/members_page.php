                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="profile-container">
                            <img class="profile-image" src="/cca/assets/img/blank-profile.png" alt="Profile Picture"
                                id="blank-profile">
                            <button type="button" class="no-style-btn remove-profile" id="removeProfile">
                                Remove Profile
                            </button>
                            <button type="button" class="no-style-btn" id="addProfileButton">Add Profile</button>
                            <input type="file" name="profile_img" class="input-profile" id="inputProfile"
