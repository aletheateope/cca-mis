...
$sql = "SELECT event_request.event_request_id, account_organization.name as organization, title, description, location, start_date, end_date, start_time, end_time
        FROM event_request
